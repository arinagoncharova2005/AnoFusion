...
INPUT_PATH = Path("data/mobservice2_stru_my.csv")
TEMPLATE_PATH = Path("data/mobservice2_temp.csv")
STRUCT_OUT_PATH = Path("data/mobservice2_stru_out.csv")
TEMP_OUT_PATH = Path("data/mobservice2_temp_out.csv")
CHUNK_SIZE = 200_000
